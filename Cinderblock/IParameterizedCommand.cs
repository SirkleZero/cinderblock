namespace Cinderblock
{
    ...
    public interface IParameterizedCommand<T1>
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="parameter">The generic type used to parameterize the command.</param>
        void Execute(T1 parameter);
    }

    #endregion

    #region IParameterized<T1, T2>
    ...
    public interface IParameterizedCommand<T1, T2>
    {
        /// <summary>
        /// Determines if the command meets its requirements for execution.
        /// </summary>
    ...
    #region IParameterized<T1, T2, T3>
    ...
    public interface IParameterizedCommand<T1, T2, T3>
    {
        /// <summary>
        /// Determines if the command meets its requirements for execution.
        /// </summary>
        ...
        /// <param name="parameter2">The generic type used for the second argument to parameterize the command.</param>
        /// <param name="parameter3">The generic type used for the third argument to parameterize the command.</param>
        void Execute(T1 parameter1, T2 parameter2, T3 parameter3);
    }

    #endregion

    #region IParameterized<T1, T2, T3, T4>
    ...
    public interface IParameterizedCommand<T1, T2, T3, T4>
    {
        ...
        /// <param name="parameter3">The generic type used for the third argument to parameterize the command.</param>
        /// <param name="parameter4">The generic type used for the fourth argument to parameterize the command.</param>
        void Execute(T1 parameter1, T2 parameter2, T3 parameter3, T4 parameter4);
    }

    #endregion

    #region IParameterized<T1, T2, T3, T4, T5>
    ...
    public interface IParameterizedCommand<T1, T2, T3, T4, T5>
    {
        /// <summary>
        /// Determines if the command meets its requirements for execution.
        /// </summary>
        ...
        /// <param name="parameter4">The generic type used for the fourth argument to parameterize the command.</param>
        /// <param name="parameter5">The generic type used for the fifth argument to parameterize the command.</param>
        void Execute(T1 parameter1, T2 parameter2, T3 parameter3, T4 parameter4, T5 parameter5);
    }

    #endregion

    #region IParameterized<T1, T2, T3, T4, T5, T6>
    ...
    public interface IParameterizedCommand<T1, T2, T3, T4, T5, T6>
    {
        /// <summary>
        /// Determines if the command meets its requirements for execution.
        /// </summary>
        ...
        /// <param name="parameter5">The generic type used for the fifth argument to parameterize the command.</param>
        /// <param name="parameter6">The generic type used for the sixth argument to parameterize the command.</param>
        void Execute(T1 parameter1, T2 parameter2, T3 parameter3, T4 parameter4, T5 parameter5, T6 parameter6);
    }
