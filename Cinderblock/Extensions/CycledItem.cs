namespace System.Collections.Generic
{
    ...
    {
        /// <summary>
        /// 	<para>Initializes an instance of the <see cref="T:CycledItem{T, TIdentifier}"/> class.</para>
        /// </summary>
        /// <param name="item">The generic item of type <see cref="T:{T}"/> that is wrapped.</param>
        ...
        /// <summary>
        /// Gets the generic item of type <see cref="T:{T}"/> that is wrapped.
        /// </summary>
