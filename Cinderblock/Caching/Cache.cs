...
namespace Cinderblock.Caching
{
    public abstract class Cache : ICache
    {
        ...
        /// </exception>
        public abstract void Add<T>(string key, T item);
        ...
        /// </exception>
        public abstract void Add<T>(string key, T item, DateTime absoluteExpiration);
        ...
        /// </exception>
        public abstract void Add<T>(string key, T item, TimeSpan cacheDuration);
